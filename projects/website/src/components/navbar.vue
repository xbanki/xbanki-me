...
<template>
    ...
    <Teleport to="main#xbanki-ui">
        ...
        <nav class="pointer-events-none! container mx-auto py-6 *:pointer-events-auto">
            <section
                class="group flex w-fit cursor-pointer items-center transition-colors"
                v-if="!router.currentRoute.value.meta.hide_logo"
            >
                <!-- Logo component. //-->
