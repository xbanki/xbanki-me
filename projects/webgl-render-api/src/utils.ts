 ...
 * @returns New canvas element with the given styles.
 */
 ...
 * @returns Is element instance of `HTMLCanvasElement`.
 */
 ...
 * @returns Created canvas element with applied styles.
 */
 ...
 * @returns Value which has been clamped between `0.0` -> `1000.0`
 */
